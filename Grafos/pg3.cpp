/*
  + Caminos mínimos: [d]ijkstra & [b]ellman-ford-moore
*/
  ...
  while ((grafito.dirigido == 0 || grafito.dirigido == 1) && errorapertura == 0)
  {
    if (grafito.dirigido == 0)
    {
      while (opcion != 'q' && grafito.dirigido == 0)
      {
        ...
        cout << "o. Mostrar componentes c[o]nexas del grafo." << endl;
        cout << "q. Finalizar el programa." << endl;
        cout << "Introduzca la letra de la acción a ejecutar: ";
        cin >> opcion;
        while (opcion != 'c' && opcion != 'i' && opcion != 'a' && opcion != 'q' && opcion != 'o')
        {
          cout << endl
    ...
    if (grafito.dirigido == 1 && errorapertura == 0)
    {
      while (opcion != 'q' && grafito.dirigido == 1)
      {
        ...
        cout << "b. Caminos mínimos: [b]ellman-ford-moore." << endl;
        cout << "q. Finalizar el programa." << endl;
        cout << "Introduzca la letra de la acción a ejecutar: ";
        cin >> opcion;
        while (opcion != 'c' && opcion != 'i' && opcion != 's' && opcion != 'p' && opcion != 'd' && opcion != 'b' && opcion != 'q')
        {
          cout << endl
               << "Ha introducido una opción no correcta. Por favor introduzca otra nuevamente: " << endl;
          cin >> opcion;
        ...
        case 'i':
          ...
          break;
        case 's':
          grafito.Mostrar_Listas(1);
          break;
        case 'p':
          grafito.Mostrar_Listas(0);
          break;
        case 'd':
          grafito.Dijkstra();
          break;
